...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "BONSAICOIN OFFICIAL LAUNCHING ON 03/08/2017";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1501750445, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1501750445;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 901661;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000006bc089ce5bf88bd399fdecc7087d2a734f5bb0f6ebb67dbf1822cca5c66"));
        assert(genesis.hashMerkleRoot == uint256("0x69195dbeda5fe5b67badd76302be986bd4345c0175782cbe22157a08631c66f5"));

        MineGenesis(genesis);

        vSeeds.push_back(CDNSSeedData("211.28.146.48", "108.61.184.197"));
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // bonsaicoin test net start with T
